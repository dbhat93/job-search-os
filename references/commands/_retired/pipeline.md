<!-- RETIRED 2026-09-12. Reason: Pipeline view is a DERIVED block regenerated by `sync`, and `strategy` reads it. Zero unique function. Restore by moving back to references/commands/ and re-adding the registry row in COACH.md. -->
